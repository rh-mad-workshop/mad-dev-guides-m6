...
// image::https://github.com/danieloh30/mad-dev-m6-guides/workflows/docs/badge.svg[docs]
...
http://localhost:3000/mad-dev-guides-m6/main/1-introduction.html?USERID=user1&SUBDOMAIN=cluster-8s5ss.sandbox701.opentlc.com&TOMCATIP=150.240.99.53
...
[source,bash]
----
oc new-app  https://github.com/RedHat-Middleware-Workshops/mad-dev-guides-m6.git --strategy=docker

oc create route edge mad-dev-guides-m6 --service=mad-dev-guides-m6
----
