...
This section provides a small introduction on how to use Jupyter Notebooks. If you are already at ease with Jupyter, you can directly head to the link:3-model-deployment.html[next section].
...
Now that you are more familiar with notebooks, you are ready to go to the link:3-model-deployment.html[next section].
